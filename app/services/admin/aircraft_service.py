...
from app.schemas.admin.aircraft import AircraftCreate, SeatClassCreate, AircraftUpdate, SeatClassUpdate, AircraftSeatCreate

from app.models.flights import  Aircraft, SeatClass, FlightSeatPricing, AircraftSeat
