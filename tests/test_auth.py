...
class TestRegister:
    async def test_passenger_can_register(self, unauthenticated_client: AsyncClient, seed_users):
        with mock_email():
    ...
    async def test_register_invalid_email_returns_422(self, unauthenticated_client: AsyncClient):
        with mock_email():
            resp = await unauthenticated_client.post(
                "/api/v1/auth/register",
                json={
    ...
    async def test_register_invalid_phone_returns_422(self, unauthenticated_client: AsyncClient):
        with mock_email():
            resp = await unauthenticated_client.post(
                "/api/v1/auth/register",
                json={
    ...
    async def test_register_valid_ph_phone_accepted(self, unauthenticated_client: AsyncClient):
        with mock_email():
            resp = await unauthenticated_client.post(
                "/api/v1/auth/register",
                json={
...
class TestLogin:
    ...
    async def test_nonexistent_email_returns_401(self, unauthenticated_client: AsyncClient):
        resp = await unauthenticated_client.post(
            "/api/v1/auth/login",
            json={
    ...
    async def test_login_missing_fields_returns_422(self, unauthenticated_client: AsyncClient):
...
class TestMe:
    ...
    async def test_invalid_token_returns_401(self, unauthenticated_client: AsyncClient):
        resp = await unauthenticated_client.get(
            "/api/v1/auth/me",
...
class TestResetPassword:
    ...
    async def test_password_too_short_returns_422(self, unauthenticated_client: AsyncClient):
        resp = await unauthenticated_client.post(
            "/api/v1/auth/reset-password",
            json={
                "token": "sometoken",
...
class TestAdminRegister:
    ...
    async def test_passenger_cannot_register_admin(self, passenger_client: AsyncClient):
        resp = await passenger_client.post(
            "/api/v1/auth/admin/register",
            json={
                "first_name": "Fake",
                "last_name": "Admin",
    ...
    async def test_unauthenticated_cannot_register_admin(self, unauthenticated_client: AsyncClient):
        resp = await unauthenticated_client.post(
            "/api/v1/auth/admin/register",
            json={
                "first_name": "Fake",
